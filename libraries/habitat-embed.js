...
//=======//
{
  const install = (global) => {
    Reflect.defineProperty(global.Array.prototype, "last", {
      ...
      set(value) {
        Reflect.defineProperty(this, "last", {
          value,
          configurable: true,
          writable: true,
          enumerable: true,
    ...
    Reflect.defineProperty(global.Array.prototype, "clone", {
      ...
      set(value) {
        Reflect.defineProperty(this, "clone", {
          value,
          configurable: true,
          writable: true,
          enumerable: true,
...
//=========//
{
  ...
  const install = (global) => {
    ...
    Reflect.defineProperty(global.Object.prototype, "dir", {
      ...
      set(value) {
        Reflect.defineProperty(this, "dir", {
          value,
          configurable: true,
          writable: true,
          enumerable: true,
    ...
    Reflect.defineProperty(global.Object.prototype, "d9", {
      ...
      set(value) {
        Reflect.defineProperty(this, "d9", {
          value,
          configurable: true,
          writable: true,
          enumerable: true,
...
//=======//
{
  const install = (global) => {
    Reflect.defineProperty(global.EventTarget.prototype, "on", {
      ...
      set(value) {
        Reflect.defineProperty(this, "on", {
          value,
          configurable: true,
          writable: true,
          enumerable: true,
        ...
        return new Proxy(this, {
          ...
          get(object, propertyName) {
            const editor = {
              get value() {
                const descriptor =
                  Reflect.getOwnPropertyDescriptor(object, propertyName) || {};
                const { value } = descriptor;
                return value;
              },
              set value(value) {
                const { enumerable, configurable, writable } =
                  Reflect.getOwnPropertyDescriptor(object, propertyName) || {
                    enumerable: true,
                    configurable: true,
                    writable: true,
              ...
              set get(get) {
                const { set, enumerable, configurable } =
                  Reflect.getOwnPropertyDescriptor(object, propertyName) || {
                    enumerable: true,
                    configurable: true,
                  };
              ...
              set set(set) {
                const { get, enumerable, configurable } =
                  Reflect.getOwnPropertyDescriptor(object, propertyName) || {
                    enumerable: true,
                    configurable: true,
                  };
              ...
              set writable(v) {
                const oldDescriptor = Reflect.getOwnPropertyDescriptor(
                  object,
                  propertyName
...

{
  ...
  Habitat.Tween.EASE_IN_EXP = Habitat.Tween.EASE_IN_EXPONENTIAL = (e) => (t) =>
    Math.pow(2, e * t - e) * t;
  Habitat.Tween.EASE_OUT_EXP = Habitat.Tween.EASE_OUT_EXPONENTIAL =
    (e) => (t) =>
      1 - Math.pow(2, -e * t) * (1 - t);
  Habitat.Tween.EASE_IN_OUT_EXP = Habitat.Tween.EASE_IN_OUT_EXPONENTIAL =
    (e) => (t) => {
      let f;
  ...
  Habitat.Tween.EASE_IN_ELASTIC = (t) =>
    -Math.pow(2, 10 * t - 10) * Math.sin(((t * 10 - 10.75) * 2 * Math.PI) / 3);
  Habitat.Tween.EASE_OUT_ELASTIC = (t) =>
  ...
  Habitat.Tween.EASE_IN_BOUNCE = (t) =>
    1 - Habitat.Tween.EASE_OUT_BOUNCE(1 - t);
